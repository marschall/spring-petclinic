...
public class Unistd {
	...
	private static class getpagesize {
		...
		public static final FunctionDescriptor DESC = FunctionDescriptor.of(Unistd.C_INT);

		public static final MemorySegment ADDR = Unistd.findOrThrow("getpagesize");
	 ...
	 * {@snippet lang = c : * extern int getpagesize()
	 * }
	 */
